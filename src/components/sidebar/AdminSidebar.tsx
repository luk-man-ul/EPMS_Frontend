...
const menuItems = [
  ...
  { label: 'Work Approval', path: '/admin/tasks/approval', permission: 'tasks.approve' },
  { label: 'Attendance Dashboard', path: '/admin/attendance/reports', permission: 'attendance.viewAll' },
  { label: 'Leave Approvals', path: '/admin/leave/approvals', permission: 'leave.viewAll' },
